...
class ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    var colorResult : [(Int,Int,Int)]?
//    var image: UIImage?
//    var segmentIndex : Int?

    @IBOutlet weak var AverageAllImageView: UIView!
    @IBOutlet weak var AverageAllLabel: UILabel!
    @IBOutlet weak var DominateImageView: UIView!
    @IBOutlet weak var DominateLabel: UILabel!
    @IBOutlet weak var AverageMiddleImageView: UIView!
    @IBOutlet weak var AverageMiddleLabel: UILabel!
    @IBOutlet weak var AverageLighterImageView: UIView!
    @IBOutlet weak var AverageLighterLabel: UILabel!
    @IBOutlet weak var AverageDarkerImageView: UIView!
    @IBOutlet weak var AverageDarkerLabel: UILabel!
    ...
    func getResult(){
        if(colorResult != nil){
            let colorResultCheck = colorResult!
            
            self.AverageAllLabel.text = "R\(colorResultCheck[1].0) G\(colorResultCheck[1].1) B\(colorResultCheck[1].2)"
            self.DominateLabel.text = "R\(colorResultCheck[0].0) G\(colorResultCheck[0].1) B\(colorResultCheck[0].2)"
            self.AverageMiddleLabel.text = "R\(colorResultCheck[2].0) G\(colorResultCheck[2].1) B\(colorResultCheck[2].2)"
            self.AverageLighterLabel.text = "R\(colorResultCheck[3].0) G\(colorResultCheck[3].1) B\(colorResultCheck[3].2)"
            self.AverageDarkerLabel.text = "R\(colorResultCheck[4].0) G\(colorResultCheck[4].1) B\(colorResultCheck[4].2)"
            
            self.AverageAllImageView.backgroundColor = UIColor(red: CGFloat(colorResultCheck[1].0)/255, green: CGFloat(colorResultCheck[1].1)/255, blue: CGFloat(colorResultCheck[1].2)/255, alpha: 1)
            self.DominateImageView.backgroundColor = UIColor(red: CGFloat(colorResultCheck[0].0)/255, green: CGFloat(colorResultCheck[0].1)/255, blue: CGFloat(colorResultCheck[0].2)/255, alpha: 1)
            self.AverageMiddleImageView.backgroundColor = UIColor(red: CGFloat(colorResultCheck[2].0)/255, green: CGFloat(colorResultCheck[2].1)/255, blue: CGFloat(colorResultCheck[2].2)/255, alpha: 1)
            self.AverageLighterImageView.backgroundColor = UIColor(red: CGFloat(colorResultCheck[3].0)/255, green: CGFloat(colorResultCheck[3].1)/255, blue: CGFloat(colorResultCheck[3].2)/255, alpha: 1)
            self.AverageDarkerImageView.backgroundColor = UIColor(red: CGFloat(colorResultCheck[4].0)/255, green: CGFloat(colorResultCheck[4].1)/255, blue: CGFloat(colorResultCheck[4].2)/255, alpha: 1)
            
            //self?.averageView.backgroundColor = UIColor(red: CGFloat(b!.0)/255, green: CGFloat(b!.1)/255, blue: CGFloat(b!.2)/255, alpha: 1)
        }
    }
...
//                self?.averageFiveLabel.text = "get Average5 R\(a?.0 ?? 0) G\(a?.1 ?? 0) B\(a?.2 ?? 0)"
//                self?.averageView.backgroundColor = UIColor(red: CGFloat(b!.0)/255, green: CGFloat(b!.1)/255, blue: CGFloat(b!.2)/255, alpha: 1)
//                self?.averageFiveView.backgroundColor = UIColor(red: CGFloat(a!.0)/255, green: CGFloat(a!.1)/255, blue: CGFloat(a!.2)/255, alpha: 1)
